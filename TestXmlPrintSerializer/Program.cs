...
using XmlPrintHandler;

namespace TestXmlPrintHandler
{
    class Program
    {
        ...
        {
            Console.WriteLine("Generovanie XML");
            ...
            Console.WriteLine("XML Bolo úspešne vygenerované");
            Console.WriteLine("Stlačte ľubovolnú klávesu pre exit");
            Console.ReadKey();
        }
    }
}
